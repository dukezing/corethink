...
VALUES
	...
	(9, 0, 1, 1, '会员', 'User/lists', '', '', '', 0, 'fa fa-users', 1435894071, 1435895080, 9, 1),
	(10, 0, 1, 1, '标签', 'Tag/index', '', '', '', 0, 'fa fa-tags', 1435896603, 1435896603, 11, 1),
	(15, 0, 3, 1, '底部导航', '', '', '', '', 1, 'fa fa-navicon', 1435896768, 1435896768, 1, 1),
	(16, 15, 3, 1, '关于', '', '', '', '', 0, '', 1435896839, 1435896839, 0, 1),
	(17, 16, 3, 2, '关于我们', '', '<p style=\"font-size:16px;font-family:\'Trebuchet MS\';\">\r\n	一、公司简介\r\n</p>\r\n<p style=\"text-align:justify;text-indent:28px;font-family:\'Trebuchet MS\';color:#5C5C5C;\">\r\n	南京科斯克网络科技有限公司（CoreThink）是一家新兴的互联网＋项目技术解决方案提供商。由一支的九零后团队创建，成立于六朝古都南京，坐落于国家级科技园，怀着炽热的心冲刺在兵荒马乱的互联网时代。我们用敏锐的视角洞察IT市场的每一次变革，我们顶着时代变迁的浪潮站在了前沿，以开拓互联网行业新渠道为己任。\r\n</p>\r\n<p style=\"text-align:justify;text-indent:28px;font-family:\'Trebuchet MS\';color:#5C5C5C;\">\r\n	作为互联网＋项目技术服务提供商，我们致力于为用户提供成熟的互联网产品开发服务及相关技术解决方案支持。我们拥有独立的高端服务器，托管于阿里云，为客户提供提供WEB程序开发、微信开发、网站系统开发、管理信息系统开发及其他互联网软件开发等服务。行业涉及机械、医药、卫生、建筑、 IT 、纺织、娱乐、物流、咨询、房产、汽车等，具有丰富的开发设计经验。面对各类行业的客户需求，我们将数据统计分析作为服务客户的首要指引，应对海量、高增长和多样化的信息资产，我们将其分为四个阶段来处理分析客户需求数据，从而来增强团队的决策力、洞见发现力和流程优化能力。为不同类型的客户提供最佳的互联网应用定制解决方案，帮助客户在新的全球化互联网环境中保持优势。\r\n</p>', '', '', 0, '', 1435896882, 1435921242, 0, 1),
	(18, 16, 3, 2, '商务合作', '', '', '', '', 0, '', 1435896882, 1435896882, 0, 1),
	...
	(28, 25, 3, 1, '游戏约', 'http://youxiyue.cn', '', '', '', 0, '', 1435922893, 1435922893, 0, 1),
	(29, 15, 3, 1, '手册', '', '', '', '', 0, '', 1435922918, 1435922918, 0, 1),
	(30, 29, 3, 1, 'CoreThink手册', '', '', '', '', 0, '', 1435922944, 1435923226, 0, 1),
	(31, 29, 3, 1, 'ThinkPHP3.2手册', 'http://document.thinkphp.cn/manual_3_2.html', '', '', '', 0, '', 1435923030, 1435923030, 0, 1);
...
VALUES
	...
	('网站标题','WEB_SITE_TITLE','CoreThink',1,'text','','网站标题前台显示标题',1378898976,1379235274,2,1),
	('网站口号','WEB_SITE_SLOGAN','轻量级WEB产品开发框架',1,'text','','网站口号、宣传标语、一句话介绍',1434081649,1434081649,2,1),
	...
	('后台主题', 'ADMIN_THEME', '', 3, 'select', 'default:默认主题\r\nblueidea:蓝色理想', '后台界面主题', 1436678171, 1436690570, 0, 1),
	...
	('分页数量','ADMIN_PAGE_ROWS','10',3,'num','','分页时每页的记录数',1434019462,1434019481, 4, 1),
...
VALUES
	(1,0,'首页','Index/index','glyphicon glyphicon-home',1426580628,1426580628,1,1),
	(2,0,'系统','SystemConfig/group','glyphicon glyphicon-cog',1426580628,1426580628,2,1),
	(3,0,'内容','Category/index','glyphicon glyphicon-tasks',1430290092,1430291772,2,1),
	(4,0,'用户','User/index','glyphicon glyphicon-user',1426580628,1426580628,3,1),
	(5,0,'其它','','glyphicon glyphicon-cloud',1426580628,1426580628,3,0),
	(6,1,'系统操作','','',1426580628,1426580628,1,1),
	(7,2,'系统功能','','',1426580628,1426580628,1,1),
	(8,2,'数据备份','','',1426580628,1426580628,2,1),
	(9,3,'文档管理','','',1430290276,1430291485,1,1),
	(10,3,'文件管理','','',1430290276,1430291485,1,1),
	(11,4,'用户管理','','',1426580628,1426580628,1,1),
	(12,6,'清空缓存','Index/rmdirr','',1427475588,1427475588,1,1),
	(13,7,'系统设置','SystemConfig/group','',1426580628,1430291269,1,1),
	(14,13,'修改','SystemConfig/groupSave','',1426580628,1426580628,1,1),
	(15,7,'文档类型','DocumentType/index','',1426580628,1430291065,2,1),
	...
	(19,15,'字段管理','DocumentAttribute/index','',1426580628,1430291065,1,1),
	...
	(23,7,'菜单管理','SystemMenu/index','',1426580628,1430291065,3,1),
	...
	(27,7,'配置管理','SystemConfig/index','',1426580628,1430291167,4,1),
	...
	(31,7,'数据字典','Datebase/index','',1429851071,1430291185,5,1),
	(32,7,'插件列表','Addon/index','',1427475588,1427475588,6,1),
	(33,32,'安装','Addon/install','',1427475588,1427475588,1,1),
	(34,32,'卸载','Addon/uninstall','',1427475588,1427475588,2,1),
	(35,32,'执行','Addon/execute','',1427475588,1427475588,3,1),
	(36,32,'插件设置','Addon/config','',1427475588,1427475588,4,1),
	(37,32,'数据列表','Addon/adminList','',1427475588,1427475588,5,1),
	(38,8,'数据备份','Datebase/export','',1426580628,1426580628,1,1),
	...
	(54,9,'标签列表','Tag/index','',1426580628,1430290718,3,1),
	...
	(62,9,'回收站','Document/recycle','',1427475588,1430290597,5,1),
	...
	(67,11,'用户列表','User/index','',1426580628,1426580628,1,1),
	...
	(71,11,'部门管理','UserGroup/index','',1426580628,1426580628,2,1),
	...
	(75,32,'新增数据','addon/adminAdd','',1426580628,1426580628,6,1),
	(76,32,'编辑数据','addon/adminEdit','',1426580628,1426580628,7,1),
	(77,32,'设置状态','addon/setStatus','',1426580628,1426580628,8,1);
